      ...
      <div class="package-card rounded-2">
        ...
        <div class="card-text-wrapper">
          ...
          <div class="button-wrapper">
            <a href="editPackage.php?id=<?php echo $id;?>" class="btn btn-primary me-2">Edit</a>
            <a href="deletePackages.php?id=<?php echo $id;?>" class="btn btn-danger">Delete</a>
          </div>
        </div>
      </div>
    </div>
    ...
    echo '<div class="container" style="text-align: center; margin-top: -30px; margin-bottom: 30px">';
      if ($total_pages > 1) {
          for ($i = 1; $i <= $total_pages; $i++) {
              ...
              $link = 'managePackages.php?page=' . $i;
              if (isset($_GET['category'])) {
